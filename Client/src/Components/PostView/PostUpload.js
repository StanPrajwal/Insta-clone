...
function PostUpload(){
  ...
  const submithandler = (e) => {
    e.preventDefault()
    console.log(image)
    Axios.post("https://instaclone-backend-prajwal.herokuapp.com/post/upload", {
      name: user.username,
    ...
    return <div>
        ...
        <div className="form-control">
            <form action="" method="" onSubmit={submithandler}>
                    ...
                    <input type="text"  placeholder="Discription" id="description" value={user.description} onChange={(e)=>handleChane(e)} />
